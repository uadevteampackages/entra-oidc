...
// source: phar:///Users/joey/code/ms-graph-api-plugins/entra-oidc/vendor/phpstan/phpstan/phpstan.phar/conf/config.level6.neon
...
class Container_661d043c29 extends _PHPStan_2d0955352\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_661d043c29 $container)
			{
	...
	public function createServiceContainer(): Container_661d043c29
	{
		return $this;
	}
