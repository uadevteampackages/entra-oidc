...
class Container_8b0bf6d12e extends _PHPStan_2d0955352\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService058(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_8b0bf6d12e $container)
			{
	...
	public function createServiceContainer(): Container_8b0bf6d12e
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'level' => 6,
			'paths' => ['/Users/joey/code/ms-graph-api-plugins/entra-oidc/src'],
			'exceptions' => [
				'implicitThrows' => true,
